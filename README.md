...
La ciencia de datos es un campo interdisciplinario que se ocupa de la extracción de conocimiento a partir de datos. Incluye técnicas y herramientas para analizar, limpiar, transformar y visualizar información con el fin de obtener valor.

Dentro de este campo se encuentra el Machine Learning, que se enfoca en el desarrollo de algoritmos y modelos capaces de aprender a partir de datos.

🎯 Propósito de la asignatura

La asignatura Machine Learning II busca que los estudiantes comprendan los fundamentos para crear algoritmos y modelos que aprenden tareas específicas a partir de datos previamente etiquetados.

El curso se centra en el aprendizaje supervisado, presentando los algoritmos más utilizados en esta área y sus aplicaciones prácticas.
